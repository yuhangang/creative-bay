...
// https://codesandbox.io/s/shoe-configurator-forked-jc9c1h?file=/public/shoe-draco.glb
...
function Shoe() {
  ...
  const { nodes, materials } = useGLTF('/shoes/shoe-draco.glb') as any;
  ...
  return (
    <div style={{ display: snap.current ? 'block' : 'none' }}>
      <HexColorPicker
        ...
        onChange={color => ((state.items as any)[snap.current] = color)}
      />
      <h1>{snap.current}</h1>
    </div>
  );
